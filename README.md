...
* Supports offloading media to S3 storage with [WP Offload Media (Lite) (formerly WP Offload S3 Lite)](https://nl.wordpress.org/plugins/amazon-s3-and-cloudfront/)
...
NOTE: When the `Remove Files From Server` option is activated under the `ADVANCED OPTIONS` section, this plugin will **NOT** remove any resized/cropped image generated by this plugin.
