...
```
**NOTE**: When the **Remove Files From Server** option is activated in the **Offload Media Lite** settings, this plugin will **NOT** remove any resized/cropped image generated by this plugin.
```
